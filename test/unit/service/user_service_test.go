...
func newTestUserService(t *testing.T) (service.UserService, *appmock.MockUserRepository, *appmock.MockCache) {
	t.Helper()
...
func TestUserService_Create_Success(t *testing.T) {
	...
	mockRepo.On("Create", ctx, mock.AnythingOfType("*model.User")).
		...
		Return(nil)
	mockCache.On("DeleteByPrefix", ctx, "users:list:").Return(nil)
